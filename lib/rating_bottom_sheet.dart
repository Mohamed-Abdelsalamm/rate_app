        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text("Please Share your opinion about the project?",style: TextStyle(fontWeight: FontWeight.bold,fontSize:20,),textAlign: TextAlign.center),
            ),
            ...
            ElevatedButton(onPressed: (){
              _onSubmitButtonPressed(context);
            },style:  ButtonStyle(backgroundColor: const MaterialStatePropertyAll(Colors.red),minimumSize: MaterialStateProperty.all(Size(MediaQuery.sizeOf(context).width, 48))), child: const Text("SEND REVIEW",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),),
          ],
        ),
      ),
    );
